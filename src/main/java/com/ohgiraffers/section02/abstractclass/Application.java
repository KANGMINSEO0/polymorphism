...
public class Application {
    ...
    public static void main(String[] args) {
        ...
        *
        *  추상클래스에 작성한 추상메소드는 반들시 후손이 오버라이딩 해서 작성해야 하며,
        ...
        *  추상메소드 경우 반드시 abstract 키워드를 메소드 헤드에 작성해야 한다.
...
//        Product product = new Product() // 추상클래스는 인스턴스 생성 불가
        ...
        product.abstMethod(); // 동적바인딩 되서 컴파일때는 Product 였다가 런타임때 SmartPhone 클래스 동작

        product.nonStaticMethod();
        Product.staticMethod(); // static 메소드 호출시 : 클래스명.메소드명
