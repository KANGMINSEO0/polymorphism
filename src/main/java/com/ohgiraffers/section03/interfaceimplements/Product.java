...
// extends 키워드를 앞에 쓰고 뒤에 implements 키워드를 쓴다

    /* 필기
    *  클래스에서 인터페이스를 상속받을 때에는 implements 키워드를 사용한다.
    *  또한 인터페이스는 여러 개를 상속받을 수 있으며.
    *  extends로 다를 클래스를 상속받는 경우에도 그것과 별개로 인터페이스 추가 상속이 가능해진다.
    ...
    * */
    ...
    public void abstMethod() {
        ...
        System.out.println("InterProduct abstMethod 오버라이딩한 메소드 호출됨...");
