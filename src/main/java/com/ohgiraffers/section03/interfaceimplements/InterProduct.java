...
public interface InterProduct {
    ...
    * */
    ...
    int MIN_NUM = 10; // 이렇게 써도 앞에 public static final이 생략된것

    /* 인터페이스는 생성자를 가질 수 없다. */
//    public InterProduct() {}

    /* 인터페이스는 구현부가 있는 non-scatic 메소드를 가질 수 없다. */
//    public void nonStaticMethod() {}
    ...
    * */
    ...
    public default void defaultMethod() {
        System.out.println("InterProduct 클래스 defaultMethod 호출됨...");
    } // 접근제한자 default 가 아닌 클래스가 선택해서 쓸수있도록 해주는 키워드
}
